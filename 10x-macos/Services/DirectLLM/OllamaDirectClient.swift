...
/// This endpoint supports tools and streaming in the same format as OpenAI.
actor OllamaDirectClient: DirectLLMClient {
    ...
    func stream(
        ...
        let request = try DirectLLMHelpers.buildRequest(url: url, headers: headers, body: body)
